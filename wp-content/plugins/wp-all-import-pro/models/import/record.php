...
//                                }
				...
				elseif (is_wp_error($pid)) {
                    ...
                    if (!empty($articleData['post_content']) && $this->options['is_keep_former_posts'] == "no" && ($this->options['update_all_data'] == "yes" || $this->options['is_update_content']) && $this->options['import_img_tags'] ){
